...
module.exports = {
    getConfig: function(mode, publishConfig){
        ...
        var entry = {vendor: ['upolyfill' ,'uui']};
        //var buildPath = "/../target/";
        var buildPath = "/../target/" + publishConfig.artifactId + "-" + publishConfig.version;;
        ...
        return {
            ...
            resolve: {
                ...
                //别名
                alias: {
                    upolyfill: path.join(__dirname, '../vendor/uui/js/u-polyfill'),
