...
//						"stroke-width":1,
			...
			case "arrow":
				...
				start_x = x;
				start_y = y;
				current_d = "M 245.32,251.73 L 245.32,251.73 C 243.86,251.37 242.77,249.56 243.13,248.10 L 243.13,248.10 C 243.49,246.64 245.30,245.55 246.76,245.91 L 420.41,278.98 L 414.89,259.60 L 465.96,303.10 L 400.52,317.85 L 414.42,303.25 z";
				cur_shape = addSvgElementFromJson({
					"element": "path",
					"curStyles": true,
					"attr": {
...
//				if(mode !== mode_id) return;
	...
	//			var evt = opts.event
				...
				translateBack.setTranslate(left+tx, top+ty);
//				debugger;
//				translateOrigin.setRotate(90,start_x,start_y);
				var N = tlist.numberOfItems;
