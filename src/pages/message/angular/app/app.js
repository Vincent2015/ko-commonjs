var app = angular.module("app", ["ui.router", 'ui.select', 'IMChat.Controller', 'IMChat.ThirdPlug', "ngSanitize", "IMChatUrl.Service", "IMChat.Group.Controller", "IMChat.ExpressionFilter", "infiniteScroll", "IMChat.cutStringFilter",
...
//					window.temVar.loadFromString(""+(data.data));
	 ...
	 * @param {Object} e
	 */
	$scope.openWhiteBoard = function(e){
